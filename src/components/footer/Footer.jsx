  ...
  return (
    <div className="footer">
      ...
      <div className="footer__author">
        <p className="created">
          Created with <img className="heart" src="/public/icons/Heart Filled Icon.jpg" alt="" />
      ...
      <div className="footer__icons">
        <div className="footer__icon left">
          <img src="/public/icons/icon_1.jpg" alt="" />
        </div>
        <div className="footer__icon">
          <img src="/public/icons/icon_2.jpg" alt="" />
        </div>
        <div className="footer__icon right">
          <img src="/public/icons/icon_3.jpg" alt="" />
        </div>
      </div>
    </div>
  );
